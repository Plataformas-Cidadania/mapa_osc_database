DROP FUNCTION IF EXISTS portal.obter_editais_abertos();

CREATE OR REPLACE FUNCTION portal.obter_editais_abertos() RETURNS TABLE(
	tx_orgao TEXT, 
	tx_programa TEXT, 
...
BEGIN 
	RETURN QUERY 
		SELECT 
			...
			TO_CHAR(tb_edital.dt_vencimento, 'DD-MM-YYYY'::text) AS dt_vencimento, 
