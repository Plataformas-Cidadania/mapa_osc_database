DROP FUNCTION IF EXISTS portal.obter_geo_cluster(cd_tipo_regiao_req INTEGER, id_regiao_req INTEGER);

CREATE OR REPLACE FUNCTION portal.obter_geo_cluster(cd_tipo_regiao_req INTEGER, id_regiao_req INTEGER) RETURNS TABLE (
	id_regiao NUMERIC, 
