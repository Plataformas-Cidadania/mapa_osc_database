...
SELECT
	...
	ROUND(ST_Y(ST_TRANSFORM(tb_localizacao.geo_localizacao, 4674))::DECIMAL, 6)::DOUBLE PRECISION AS geo_lat,
	ROUND(ST_x(ST_TRANSFORM(tb_localizacao.geo_localizacao, 4674))::DECIMAL, 6)::DOUBLE PRECISION AS geo_lng,
...
FROM 
	osc.tb_osc
INNER JOIN 
	osc.tb_localizacao ON tb_osc.id_osc = tb_localizacao.id_osc
WHERE 
	tb_osc.bo_osc_ativa;
