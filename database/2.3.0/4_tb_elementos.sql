...
(
  ...
  ft_participacao_social_conselho text, -- Fonte de dados da informação se OSC participa de algum espaço de participação social em conselho
  bo_participacao_social_conferencia boolean, -- OSC participa de alguma espaço de participação social em conferência
  ft_participacao_social_conferencia text, -- Fonte de dados da informação se OSC participa de algum espaço de participação social em conferência
  bo_participacao_social_outro boolean, -- OSC participa de algum outro tipo de espaço de participação social
  ft_participacao_social_outro text, -- Fonte de dados da informação se OSC participa de algum outro tipo de espaço de participação social
  bo_recurso boolean, -- OSC possui recursos
  ft_recurso text, -- Fonte de dados da informação se OOSC possui recursos
  bo_certificado boolean, -- OSC possui alguma titulação ou certificação
  ft_certificado text, -- Fonte de dados da informação se OOSC possui alguma titulação ou certificação
