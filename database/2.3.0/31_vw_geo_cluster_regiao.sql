...
SELECT 
	...
	ROUND(ST_y(edre_centroid)::DECIMAL, 6)::DOUBLE PRECISION AS geo_lat_centroid_regiao, 
	ROUND(ST_X(edre_centroid)::DECIMAL, 6)::DOUBLE PRECISION AS geo_lng_centroid_regiao, 
...
SELECT 
	...
	ROUND(ST_y(eduf_centroid)::DECIMAL, 6)::DOUBLE PRECISION AS geo_lat_centroid_regiao, 
	ROUND(ST_X(eduf_centroid)::DECIMAL, 6)::DOUBLE PRECISION AS geo_lng_centroid_regiao, 
...
SELECT 
	...
	ROUND(ST_y(edmu_centroid)::DECIMAL, 6)::DOUBLE PRECISION AS geo_lat_centroid_regiao, 
	ROUND(ST_X(edmu_centroid)::DECIMAL, 6)::DOUBLE PRECISION AS geo_lng_centroid_regiao, 
