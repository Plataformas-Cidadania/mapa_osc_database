DROP FUNCTION IF EXISTS portal.atualizar_projeto_municipio(osc INTEGER, identificadorexterno TEXT, municipio INTEGER, nome TEXT, status INTEGER, datainicio DATE, datafim DATE, valortotal DOUBLE PRECISION, valorcaptado DOUBLE PRECISION, totalbeneficiarios INTEGER, abrangencia INTEGER, zonaatuacao INTEGER, orgaoconcedente TEXT, descricao TEXT, metodologiamonitoramento TEXT, link TEXT, fonte TEXT, dataatualizacao TIMESTAMP, nullvalido BOOLEAN);

CREATE OR REPLACE FUNCTION portal.atualizar_projeto_municipio(osc INTEGER, identificadorexterno TEXT, municipio INTEGER, nome TEXT, status INTEGER, datainicio DATE, datafim DATE, valortotal DOUBLE PRECISION, valorcaptado DOUBLE PRECISION, totalbeneficiarios INTEGER, abrangencia INTEGER, zonaatuacao INTEGER, orgaoconcedente TEXT, descricao TEXT, metodologiamonitoramento TEXT, link TEXT, fonte TEXT, dataatualizacao TIMESTAMP, nullvalido BOOLEAN) RETURNS TABLE(
	mensagem TEXT
)AS $$
...
BEGIN 
	SELECT INTO projeto_anterior * FROM osc.tb_projeto WHERE tx_identificador_projeto_externo = identificadorexterno AND cd_uf is null AND cd_municipio = municipio;
...
SELECT * FROM portal.atualizar_projeto_municipio(
	987654::INTEGER, -- osc INTEGER
	'16'::TEXT, -- identificadorexterno TEXT
	2919926::INTEGER, -- municipio INTEGER
	'Projeto Teste 2'::TEXT, -- nome TEXT
	1::INTEGER, -- status INTEGER
	'01-01-2016'::DATE, -- datainicio DATE
	'31-12-2016'::DATE, -- datafim DATE
	100000.00::DOUBLE PRECISION, -- valortotal DOUBLE PRECISION
	90000.00::DOUBLE PRECISION, -- valorcaptado DOUBLE PRECISION
	500::INTEGER, -- totalbeneficiarios INTEGER
	1::INTEGER, -- abrangencia INTEGER
	1::INTEGER, -- zonaatuacao INTEGER
	'Orgão concedente do projeto'::TEXT, -- orgaoconcedente TEXT
	'Descrição do Projeto Teste'::TEXT, -- descricao TEXT
	'Metodologia de monitoramento do Projeto Teste'::TEXT, -- metodologiamonitoramento TEXT
	'www.projetoteste.com.br'::TEXT, -- link TEXT
	3::TEXT, -- fonte TEXT
	'21-10-2017'::TIMESTAMP, -- dataatualizacao TIMESTAMP
	true -- nullvalido BOOLEAN
);
