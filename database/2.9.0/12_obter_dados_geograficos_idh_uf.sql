drop function if exists ipeadata.obter_dados_geograficos_idh_uf();
create function ipeadata.obter_dados_geograficos_idh_uf()
    returns TABLE
            (
                resultado json,
                mensagem  text,
...
BEGIN
    ...
    codigo := 200;
    mensagem := 'Lista de IDH de Estados retornado.';
...
alter function ipeadata.obter_dados_geograficos_idh_uf() owner to i3geo;