...
-- Teste
SELECT * FROM portal.atualizar_financiador_projeto(
...
SELECT * FROM osc.tb_financiador_projeto a JOIN osc.tb_projeto b ON a.id_projeto = b.id_projeto WHERE b.id_osc = 1548640;