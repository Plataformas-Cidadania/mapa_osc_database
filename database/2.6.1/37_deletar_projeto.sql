...
BEGIN
	...
	SELECT INTO objeto * FROM osc.tb_tipo_parceria_projeto WHERE id_projeto = id;
	...
	SELECT INTO objeto * FROM osc.tb_fonte_recursos_projeto WHERE id_projeto = id;
	...
	SELECT INTO objeto * FROM osc.tb_area_atuacao_outra_projeto WHERE id_projeto = id;
	...
	SELECT INTO objeto * FROM osc.tb_area_atuacao_projeto WHERE id_projeto = id;
	...
	SELECT INTO objeto * FROM osc.tb_financiador_projeto WHERE id_projeto = id;
	...
	SELECT INTO objeto * FROM osc.tb_localizacao_projeto WHERE id_projeto = id;
	...
	SELECT INTO objeto * FROM osc.tb_objetivo_projeto WHERE id_projeto = id;
	...
	SELECT INTO objeto * FROM osc.tb_osc_parceira_projeto WHERE id_projeto = id;
	...
	SELECT INTO objeto * FROM osc.tb_projeto WHERE id_projeto = id;
