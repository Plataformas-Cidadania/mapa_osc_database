...
BEGIN 
	...
	SELECT * FROM syst.atualizar_fontes_dados_geral('MJ/CNES/OSCIP', 'OSCIP/CNES/MJ');
	SELECT * FROM syst.atualizar_fontes_dados_geral('MJ/CNES/UPF', 'UPF/CNES/MJ');
	...
	SELECT * FROM syst.atualizar_fontes_dados_geral('MS/AS', 'AS/MS');
