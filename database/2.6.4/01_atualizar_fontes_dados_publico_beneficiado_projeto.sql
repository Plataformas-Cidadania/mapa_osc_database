...
BEGIN 
	...
	SET	ft_nome_publico_beneficiado = fonte_nova 
	WHERE ft_nome_publico_beneficiado = fonte_antiga;

	UPDATE osc.tb_publico_beneficiado_projeto 
	SET	ft_estimativa_pessoas_atendidas = fonte_nova 
	WHERE ft_estimativa_pessoas_atendidas = fonte_antiga;
