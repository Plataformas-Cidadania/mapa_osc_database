DROP FUNCTION IF EXISTS portal.obter_perfil_localidade_evolucao_quantidade_ano(INTEGER) CASCADE;

CREATE OR REPLACE FUNCTION portal.obter_perfil_localidade_evolucao_quantidade_ano(id_localidade INTEGER) RETURNS TABLE (
	dados JSONB, 
	fontes TEXT[]
) AS $$ 
