...
DECLARE
    ...
    colocacao_quantidade_osc_regiao INTEGER;
    colocacao_quantidade_osc_estado INTEGER;
    colocacao_quantidade_osc_municipio INTEGER;
    colocacao_repasses_regiao INTEGER;
    colocacao_repasses_estado INTEGER;
    colocacao_repasses_municipio INTEGER;
