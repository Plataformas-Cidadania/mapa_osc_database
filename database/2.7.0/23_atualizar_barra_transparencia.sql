...
BEGIN 
	FOR transpararencia IN SELECT * FROM portal.obter_pontuacao_barra_transparencia_osc(id_osc_req) LOOP 
        IF (SELECT COUNT(*) FROM portal.tb_barra_transparencia WHERE id_osc = id_osc_req) > 0 THEN 
            UPDATE portal.tb_barra_transparencia 
                SET 
                    transparencia_dados_gerais = transpararencia.transparencia_dados_gerais, 
                    peso_dados_gerais = transpararencia.peso_dados_gerais, 
                    transparencia_area_atuacao = transpararencia.transparencia_area_atuacao, 
                    peso_area_atuacao = transpararencia.peso_area_atuacao, 
                    transparencia_descricao = transpararencia.transparencia_descricao, 
                    peso_descricao = transpararencia.peso_descricao, 
                    transparencia_titulos_certificacoes = transpararencia.transparencia_titulos_certificacoes, 
                    peso_titulos_certificacoes = transpararencia.peso_titulos_certificacoes, 
                    transparencia_relacoes_trabalho_governanca = transpararencia.transparencia_relacoes_trabalho_governanca, 
                    peso_relacoes_trabalho_governanca = transpararencia.peso_relacoes_trabalho_governanca, 
                    transparencia_espacos_participacao_social = transpararencia.transparencia_espacos_participacao_social, 
                    peso_espacos_participacao_social = transpararencia.peso_espacos_participacao_social, 
                    transparencia_projetos_atividades_programas = transpararencia.transparencia_projetos_atividades_programas, 
                    peso_projetos_atividades_programas = transpararencia.peso_projetos_atividades_programas, 
                    transparencia_fontes_recursos = transpararencia.transparencia_fontes_recursos, 
                    peso_fontes_recursos = transpararencia.peso_fontes_recursos, 
                    transparencia_osc = transpararencia.transparencia_osc 
                WHERE 
                    id_osc = id_osc_req;
