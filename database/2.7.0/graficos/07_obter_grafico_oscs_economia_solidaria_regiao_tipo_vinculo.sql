DROP FUNCTION IF EXISTS portal.obter_grafico_oscs_economia_solidaria_regiao_tipo_vinculo() CASCADE;

CREATE OR REPLACE FUNCTION portal.obter_grafico_oscs_economia_solidaria_regiao_tipo_vinculo() RETURNS TABLE (
	dados JSONB, 
	fontes TEXT[]	
) AS $$ 
...
--SELECT * FROM portal.obter_grafico_oscs_economia_solidaria_regiao_tipo_vinculo();
