-- FUNCTION: portal.atualizar_osc(text, numeric, text, timestamp without time zone, jsonb, boolean, boolean, boolean, integer)

-- DROP FUNCTION portal.atualizar_osc(text, numeric, text, timestamp without time zone, jsonb, boolean, boolean, boolean, integer);

CREATE OR REPLACE FUNCTION portal.atualizar_osc(
	fonte text,
...
ALTER FUNCTION portal.atualizar_osc(text, numeric, text, timestamp without time zone, jsonb, boolean, boolean, boolean, integer)
    OWNER TO postgres;
