-- FUNCTION: portal.atualizar_dados_gerais_osc(text, numeric, text, timestamp without time zone, jsonb, boolean, boolean, boolean, integer, integer)

-- DROP FUNCTION portal.atualizar_dados_gerais_osc(text, numeric, text, timestamp without time zone, jsonb, boolean, boolean, boolean, integer, integer);

CREATE OR REPLACE FUNCTION portal.atualizar_dados_gerais_osc(
	fonte text,
