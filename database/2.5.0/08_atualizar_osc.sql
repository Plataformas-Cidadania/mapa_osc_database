...
BEGIN
	...
	ELSE
		...
		IF (SELECT a.flag FROM portal.verificar_dado(dado_anterior.cd_identificador_osc::TEXT, dado_anterior.ft_identificador_osc, cnpj::TEXT, fonte_dados.prioridade, nullvalido) AS a) THEN
			dado_posterior.cd_identificador_osc := cnpj;
