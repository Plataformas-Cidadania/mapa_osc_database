...
BEGIN
	...
	operacao := 'portal.atualizar_localizacao(' || fonte::TEXT || ', ' || identificador::TEXT ||', ' || tipo_identificador::TEXT || ', ' || data_atualizacao::TEXT || ', ' || json::TEXT || ', ' || null_valido::TEXT || ', ' || erro_log::TEXT || ', ' || id_carga::TEXT || ')';
