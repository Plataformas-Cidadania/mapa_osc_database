...
SELECT
	...
	dc_area_atuacao.tx_nome_area_atuacao AS tx_nome_area_atuacao,
	tb_area_atuacao.tx_nome_outra AS tx_nome_area_atuacao_outra,
	tb_area_atuacao.cd_subarea_atuacao,
	dc_subarea_atuacao.tx_nome_subarea_atuacao AS tx_nome_subarea_atuacao,
...
LEFT JOIN syst.dc_subarea_atuacao ON syst.dc_subarea_atuacao.cd_subarea_atuacao = osc.tb_area_atuacao.cd_subarea_atuacao
