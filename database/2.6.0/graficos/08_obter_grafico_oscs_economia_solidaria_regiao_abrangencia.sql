DROP FUNCTION IF EXISTS portal.obter_grafico_oscs_economia_solidaria_regiao_abrangencia() CASCADE;

CREATE OR REPLACE FUNCTION portal.obter_grafico_oscs_economia_solidaria_regiao_abrangencia() RETURNS TABLE (
	dados JSONB, 
	fontes TEXT[]	
) AS $$ 
...
SELECT * FROM portal.obter_grafico_oscs_economia_solidaria_regiao_abrangencia();
