...
BEGIN 
	...
	VALUES (tipo_usuario, LOWER(email), senha, nome, cpf, telefone1, telefone2, orgao, dado_institucional, email_confirmacao, municipio, lista_email, lista_atualizacao_anual, lista_atualizacao_trimestral, false, NOW(), NOW()) 
